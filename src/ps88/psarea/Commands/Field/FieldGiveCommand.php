<?php
    ...
    class FieldGiveCommand extends Command {
         ...
         * @param array $aliases
         */
        public function __construct( string $name = "givefield", string $description = "Give field to other Player", string $usageMessage = "/givefield [player] [id]", $aliases = ['Player', 'Id']) {
        ...
        public function execute(CommandSender $sender, string $commandLabel, array $args): bool {
            ...
            if (count(LoaderManager::$fieldloader->getAreasByOwner($pl->getName())) >= FieldLoader::Maximum_Lands) {

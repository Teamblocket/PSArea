<?php
    ...
    class FieldAddShareCommand extends Command {
         ...
         * @param array $aliases
         */
        public function __construct( string $name = "addfieldshare", string $description = "Add Field Shared Player", string $usageMessage = "/addfieldshare [player] [id]", $aliases = ['Player', 'Id']) {
        ...
        public function execute(CommandSender $sender, string $commandLabel, array $args): bool {
            ...
            $a->addShare($pl);
            $sender->sendMessage(Translator::get("you-add-share", \true, ["@player", $pl->getName()], ["@landnum", $a->getLandnum()], ["@type", "field"]));
            return \true;
        }
    }
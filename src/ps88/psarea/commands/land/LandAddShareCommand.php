<?php
    ...
    class LandAddShareCommand extends Command {
         ...
         * @param array $aliases
         */
        public function __construct( string $name = "addlandshare", string $description = "Add Land Shared Player", string $usageMessage = "/addlandshare [player] [id]", $aliases = ['Player', 'Id']) {
        ...
        public function execute(CommandSender $sender, string $commandLabel, array $args): bool {
            ...
            $a->addShare($pl);
            $sender->sendMessage(Translator::get("you-add-share", \true, ["@player", $pl->getName()], ["@landnum", $a->getLandnum()], ["@type", "land"]));
            return \true;
        }
    }